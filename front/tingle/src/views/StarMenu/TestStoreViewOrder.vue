...
// ==================주문 생성 =============================
  ...
  const createOrder = async () => {
    try {
      const response = await axios.post(`http://i10d106.p.ssafy.io/order/create/${userId.value}/${productId.value}`);
...
// ==================주문 삭제 =============================
  ...
  const deleteOrder =async () => {
    try {
      const response = await axios.post(`http://i10d106.p.ssafy.io/order/delete/${productId.value}`);
...
const getStarOrder =async () => {
  try {
    const response = await axios.get(`http://i10d106.p.ssafy.io/order/getByStarName/${starname.value}`)
...
const getOrderDetail = async () => {
  try {
    const response = await axios.get(`http://i10d106.p.ssafy.io/order/getById/${productId.value}`);
...
const getOrderByUserId =async () => {
  try {
    const response = await axios.get(`http://i10d106.p.ssafy.io/order/getUserOrders/${userId.value}`);
