...
// ==================주문 생성 =============================
  ...
  const createOrder = async () => {
    try {
      const response = await axios.post(`http://localhost:8080/order/create/${userId.value}/${productId.value}`);
...
// ==================주문 삭제 =============================
  ...
  const deleteOrder =async () => {
    try {
      const response = await axios.post(`http://localhost:8080/order/delete/${productId.value}`);
...
const getOrderDetail = async () => {
  try {
    const response = await axios.get(`http://localhost:8080/order/getById/${productId.value}`);
