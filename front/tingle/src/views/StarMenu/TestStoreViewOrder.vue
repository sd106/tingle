...
// ==================주문 생성 =============================
  ...
  const createOrder = async () => {
    try {
      const response = await axios.post(`https://i10d106.p.ssafy.io/api/order/create/${userId.value}/${productId.value}`);
...
// ==================주문 삭제 =============================
  ...
  const deleteOrder =async () => {
    try {
      const response = await axios.post(`https://i10d106.p.ssafy.io/api/order/delete/${productId.value}`);
...
const getStarOrder =async () => {
  try {
    const response = await axios.get(`https://i10d106.p.ssafy.io/api/order/getByStarName/${starname.value}`)
...
const getOrderDetail = async () => {
  try {
    const response = await axios.get(`https://i10d106.p.ssafy.io/api/order/getById/${productId.value}`);
...
const getOrderByUserId =async () => {
  try {
    ...
    const response = await axios.get(`https://i10d106.p.ssafy.io/api/order/getUserOrders/${userId.value}`);
