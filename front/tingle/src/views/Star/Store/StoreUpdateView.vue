...
const getProduct = async (productId: number) => {
  try {
    const response = await axios.get(`http://i10d106.p.ssafy.io/product/getById/${productId}`)
...
const updateProductWithOutFile =async (productInfo: any, previewFiles: string[]) => {
  try {
    ...
    const response = await axios.post('http://i10d106.p.ssafy.io/product/update/nofile', formData)
...
const updateProduct = async (productInfo: any, fileInputs: File[], previewFiles: string[]) => {
  try {
    ...
    const response = await axios.post('http://i10d106.p.ssafy.io/product/update', formData, {
      headers: {
