<template>
    ...
    <nav class="navbar fixed-top custom-navbar">
        <div class="container-fluid">
            ...
            <!-- 로그인 유무로 보이기 -->
            <RouterLink v-if="!store.isLogin" @click="loginTemp" to="/signUp">Signup</RouterLink> |
            <RouterLink v-if="!store.isLogin" to="/logIn">Login</RouterLink> |
            <span v-if="store.isLogin" @click="logOut">Logout</span>
            <!-- 사용자 프로필 사진 > 모달로 메뉴 -->
