  ...
  <main>
    ...
    <div v-if="editor" class="tw-flex tw-flex-wrap tw-gap-2">
      ...
      <button @click="editor.chain().focus().toggleBold().run()"
        :disabled="!editor.can().chain().focus().toggleBold().run()" class="tw-btn"
        :class="{ 'tw-bg-gray-300': editor.isActive('bold') }">
        <i class="fas fa-bold"></i>
      </button>

      <!-- Italic -->
      <button @click="editor.chain().focus().toggleItalic().run()"
        :disabled="!editor.can().chain().focus().toggleItalic().run()" class="tw-btn"
        :class="{ 'tw-bg-gray-300': editor.isActive('italic') }">
        <i class="fas fa-italic"></i>
      </button>

      <!-- Strike -->
      <button @click="editor.chain().focus().toggleStrike().run()"
        :disabled="!editor.can().chain().focus().toggleStrike().run()" class="tw-btn"
        :class="{ 'tw-bg-gray-300': editor.isActive('strike') }">
      ...
      <!-- Heading 1 -->
      <button @click="editor.chain().focus().toggleHeading({ level: 1 }).run()" class="tw-btn"
        :class="{ 'tw-bg-gray-300': editor.isActive('heading', { level: 1 }) }">
        <i class="fas fa-heading"></i> H1
      </button>

      <!-- Heading 2 -->
      <button @click="editor.chain().focus().toggleHeading({ level: 2 }).run()" class="tw-btn"
        :class="{ 'tw-bg-gray-300': editor.isActive('heading', { level: 2 }) }">
        <i class="fas fa-heading"></i> H2
      </button>

      <!-- Heading 3 -->
      <button @click="editor.chain().focus().toggleHeading({ level: 3 }).run()" class="tw-btn"
        :class="{ 'tw-bg-gray-300': editor.isActive('heading', { level: 3 }) }">
